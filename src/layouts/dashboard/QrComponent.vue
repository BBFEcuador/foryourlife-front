...
const link = computed(() => {
  if (!props.invitations?.token) return '';
  return `${window.location.origin}/register/${props.invitations.token}`;
});
</script>
      ...
      <div class="tw:flex tw:flex-col tw:items-center tw:gap-6">
        ...
        <div class="tw:w-full tw:space-y-2">
          ...
          <div class="tw:flex tw:gap-2">
            <v-text-field v-model="link" readonly variant="outlined" density="comfortable" hide-details class="tw:flex-1" bg-color="white">
              <template #append-inner>
                ...
                >
                  <div class="tw:relative">
                    <Icon icon="mdi:content-copy" height="20" class="tw:transition-transform group-hover:tw:scale-110" />
