...
<template>
    <v-dialog v-model="isOpen" max-width="600" persistent>
        <v-card class="rounded-xl">
                    ...
                    <v-row>
                        ...
                        <v-col cols="12">
                            <v-textarea v-model="formData.description" label="Descripción"
                                ...
                                variant="outlined" density="comfortable" rows="2" auto-grow required />
                        </v-col>
                        ...
                        <v-col cols="12">
                            <v-select v-model="formData.programs" :items="programs" item-title="name" item-value="id"
                                label="Programas"
                                :error-messages="v$.programs.$errors.map((e: any) => e.$message as string)" multiple
            ...
            <v-card-actions>
                <v-spacer />
                <v-btn color="error" variant="flat" :disabled="isLoading" @click="closeDialog">
                    Cancelar
                </v-btn>
