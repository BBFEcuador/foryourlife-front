...
<template>
  ...
  <div v-if="checkPermission(PermissionEnum.SEE_TRAINERS)">
    <v-row>
      <v-col cols="12">
          ...
          >
            <template v-slot:top>
              ...
              >
                ...
                <v-spacer></v-spacer>
                <VBtn
                  v-if="checkPermission(PermissionEnum.CREATE_TRAINERS)"
                  variant="elevated"
                  color="primary"
            ...
            <template #item.actions="{ item }">
              <div class="tw:flex tw:gap-2">
                <VBtn
                  v-if="checkPermission(PermissionEnum.UPDATE_TRAINERS)"
                  icon
                  color="info"
                  variant="text"
                  size="32"
