                    ...
                    <v-card class="mb-4 payment-card">
                        ...
                        <v-card-text>
                            <GeneralPayment @update:selected-participant="selectedParticipant = $event"
                                ...
                                @update:fullname="fullname = $event" @update:address="address = $event"
                                @update:document="document = $event" @update:phone="phone = $event"
                                @update:email="email = $event" @update:selected-discount="selectedDiscount = $event"
