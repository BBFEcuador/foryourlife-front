        ...
        <UiParentCard title="Información base" class="rounded-lg elevation-2">
          <div class="mb-4 tw:grid tw:grid-cols-2 tw:gap-4">
            ...
            <InputSection label="Segundo Nombre" class="mb-4">
              <VTextField
                placeholder="Segundo Nombre del usuario"
                v-model="admin.name2"
                :error-messages="validator.name2.$errors.map((x) => x.$message.toString())"
                variant="outlined"
                bg-color="surface"
                class="rounded-lg"
              />
            ...
            <InputSection label="Primer Apellido" class="mb-4">
              <VTextField
                ...
                v-model="admin.lastName1"
                :error-messages="validator.lastName1.$errors.map((x) => x.$message.toString())"
                variant="outlined"
                bg-color="surface"
                class="rounded-lg"
              />
            ...
            <InputSection label="Segundo Apellido" class="mb-4">
              <VTextField
                ...
                v-model="admin.lastName2"
                :error-messages="validator.lastName2.$errors.map((x) => x.$message.toString())"
                variant="outlined"
                bg-color="surface"
                class="rounded-lg"
              />
